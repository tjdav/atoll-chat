...
ARG ATOLL_VAPID_PUBLIC_KEY="BG6jbL6oHXUyR8hntptF57uh1ZC229JFqe0t4moskBqFNFhN8nYrCUma47Vmlg7eL1NhmyO8BKznjpqTx_T-7XQ"
...
ENV ATOLL_OWNER_EMAIL=""
ENV PB_ADMIN_EMAIL=""

# SMTP Configuration
ENV ATOLL_SMTP_ENABLED=""
ENV ATOLL_SMTP_HOST=""
ENV ATOLL_SMTP_PORT="587"
ENV ATOLL_SMTP_USERNAME=""
ENV ATOLL_SMTP_PASSWORD=""
ENV ATOLL_SMTP_TLS="false"
ENV ATOLL_SMTP_AUTH_METHOD="PLAIN"
ENV ATOLL_SMTP_LOCAL_NAME=""
ENV ATOLL_SMTP_SENDER_NAME="Atoll Chat"
ENV ATOLL_SMTP_SENDER_ADDRESS="noreply@atoll.chat"

WORKDIR /pb/push-worker
COPY ./push-worker ./
RUN CI=true pnpm install --prod --node-linker=hoisted
