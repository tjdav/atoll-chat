...
ARG ATOLL_DATABASE_URL="/"
ARG ATOLL_VAPID_KEY="BI42LscA_XvC28RpxgGk_g0-XW5yC4S_N924_68yL4Zpx8aX_P1_x2_58yL4Zpx8aX_P1_x2_58yL4Zpx8aX_P1_x2"
...
ENV ATOLL_DATABASE_URL=${ATOLL_DATABASE_URL}
ENV ATOLL_VAPID_KEY=${ATOLL_VAPID_KEY}
