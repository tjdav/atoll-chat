...
describe('Auth Login Recovery Workflow', () => {
  ...
  test('should render "Forgot password? Recover with code" button on login view', async () => {
    ...
    const btnShowRecovery = el.querySelector('[data-testid$="btnShowRecovery"]')
  ...
  test('should switch to viewRecovery and prefill username when btnShowRecovery is clicked', async () => {
    ...
    const usernameInput = el.querySelector('[data-testid$="username"]')
    if (usernameInput) {
    ...
    const viewLogin = el.querySelector('[data-testid$="viewLogin"]')
    const viewRecovery = el.querySelector('[data-testid$="viewRecovery"]')
    ...
    const recoveryUsernameInput = el.querySelector('[data-testid$="recoveryUsername"]')
  ...
  test('should switch back to viewLogin and clear code when btnCancelRecovery is clicked', async () => {
    ...
    const recoveryCodeInput = el.querySelector('[data-testid$="recoveryCodeInput"]')
    recoveryCodeInput.value = 'RC-1234-5678-9012-3456'

    const btnCancelRecovery = el.querySelector('[data-testid$="btnCancelRecovery"]')
