  ...
  return definePlugin({
    ...
    server: {
      ...
      onAfterBuild: async ({ app }) => {
        ...
        const iosTeamId = config?.iosTeamId || 'TEAMID1234'
        const iosAppId = config?.iosAppId || 'com.atollchat.app'
        const aasaContent = {
          applinks: {
            details: [
              {
        ...
        const packageName = config?.androidPackageName || 'com.atollchat.app'
        const fingerprint = config?.androidCertFingerprint || 'FA:C6:17:45:DC:09:03:78:6F:B9:ED:E6:2A:96:2B:39:9F:73:48:F0:BB:6F:89:9B:83:32:66:75:91:03:3B:9C'
